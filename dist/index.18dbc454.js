...
// Draw the network
(0, _network.drawNetwork)(nodes, edges);

},{"./legend":"ieevi","./load-data":"9ZwCu","./matrix":"bhcXq","./arc":"cq48B","./beeswarm":"kFA5m","./network":"hhhnT"}],"ieevi":[function(require,module,exports) {
...
},{"./constant.js":"bqryx","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"hhhnT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const drawNetwork = (nodes, edges)=>{
    ...
    const simulation = (0, _d3Force.forceSimulation)().force("charge", (0, _d3Force.forceManyBody)().strength(-800)).force("collide", (0, _d3Force.forceCollide)().radius((d)=>d.radius + 2)).force("center", (0, _d3Force.forceCenter)().x(0).y(0)).force("link", (0, _d3Force.forceLink)().id((d)=>d.id)).nodes(networkNodes).on("tick", updateNetwork);
    simulation.force("link").links(networkEdges);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8","d3-force":"helua","d3-selection":"gn9gd","./scales":"NYsfE","d3-array":"1yX2W"}]},["fdTx9","1SICI"], "1SICI", "parcelRequire94c2")
